const teams = [
  {
    id: 0,
    title: "DSA",
    imageTitle: "assets/titleDSA.png",
    html: (
      <div>
        <p>
          Data Structure and Algorithm is a prime branch of Computer Science. It
          deals with creating machine-efficient and optimized computer programs.
          Nearly, each and every tech giant, be it Amazon, Google, Microsoft or
          any other top tech company, recruits professionals on the basis of
          their mastery in this field.
        </p>
      </div>
    ),
  ...
  },
  {
    ...
    html: (
      <div>
        <p>
          The AI/ML team at IEEE CS aims to build a strong community of support
          for ML enthusiasts. JMI students will be able to compete in
          competitions, from generating the best ML model on datasets to
          creating end-to-end deployable ML products. "AI is the new
          electricity," says Andrew Ng (Founder & CEO of LandingAI).
        </p>
      </div>
    ),
